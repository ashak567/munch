...
export default function ProfilePage() {
  ...
  const [activeTab, setActiveTab] = useState<'profile' | 'hups' | 'memory' | 'nicknames'>('profile')
    ...
    <div className="flex-grow flex flex-col py-6">
      ...
      <div className="flex gap-2 mb-6 bg-white/40 p-1 rounded-2xl border border-white/50 w-full max-w-md">
        <button
          ...
          className={`flex-grow py-2 px-2.5 rounded-xl text-[10px] font-bold transition-all cursor-pointer ${
            activeTab === 'profile'
